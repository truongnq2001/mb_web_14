<%-- 
    Document   : dang-ki
    Created on : Jun 18, 2022, 10:39:36 PM
    Author     : Admin
--%>
            ...
            <div class="form-content">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <input id="email" name="email" type="text" placeholder="VD: Nguyễn Văn A" class="form-control" onblur="isRequired('#email')">
                ...
                <div class="form-footer">
                    <button type="button" class="form-submit" onclick="validate()">ĐĂNG KÝ</button>
                </div>
